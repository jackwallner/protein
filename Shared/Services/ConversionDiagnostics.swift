...
/// On-device record of how someone met Protein+ before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.protein", category: "Conversion")
    ...
    static let suiteName = "group.com.jackwallner.protein"
    ...
    private static let impressionPrefix = "protein_"
